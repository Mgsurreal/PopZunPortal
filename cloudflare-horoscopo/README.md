...
6. Na Cloudflare, associe a rota `popzun.com.br/api/horoscopo*` ao Worker `popzun-horoscopo`.
...
O modelo escolhido é o pequeno `@cf/meta/llama-3.2-3b-instruct`, suficiente para texto curto e econômico dentro da franquia diária do Workers AI.
